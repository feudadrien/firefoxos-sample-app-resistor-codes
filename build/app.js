...
enyo.path.addPaths({layout: "/Users/soapdog/prog/app-resistor-codes/enyo/../lib/layout/", onyx: "/Users/soapdog/prog/app-resistor-codes/enyo/../lib/onyx/", onyx: "/Users/soapdog/prog/app-resistor-codes/enyo/../lib/onyx/source/"});
...
rendered: function() {
this.inherited(arguments), this.$.colorName.setContent(this.content), this.$.box.applyStyle("background", this.color);
},
getInfo: function() {
var e = {
content: this.content,
...
create: function() {
this.inherited(arguments), this.$.header.setContent(this.title), this.info = this.$.first.getInfo();
},
colorSelected: function(e, t) {
this.info = t.selected.getInfo();
},
getInfo: function() {
return this.info;
}
...
var e = [ this.$.band1.getInfo(), this.$.band2.getInfo(), this.$.band3.getInfo(), this.$.band4.getInfo() ];
return e;
},
formatResistorValue: function(e, t) {
var n = 1e3, r = n * 1e3, i = r * 1e3, s = i * 1e3;
return e >= 0 && e < n ? e + " &ohm;" : e >= n && e < r ? (e / n).toFixed(t) + " K&ohm;" : e >= r && e < i ? (e / r).toFixed(t) + " M&ohm;" : e >= i && e < s ? (e / i).toFixed(t) + " G&ohm;" : e >= s ? (e / s).toFixed(t) + " T&ohm;" : e + " &ohm;";
},
helloWorldTap: function(e, t) {
var n = this.getColorSelection(), r = Math.pow(10, n[2].multiplier), i = n[3].tolerance || 0, s = n[0].value + "" + n[1].value;
s *= r, this.log("Value", s), this.log("Tolerance:", i), this.$.main.setContent("<h3>Value: " + this.formatResistorValue(s, 1) + " &plusmn;" + i + "%" + "</h3>");
}
});
